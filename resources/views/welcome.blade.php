...
<body>
        ...
        <nav class="navbar navbar-expand-lg navbar-dark px-5 py-3 py-lg-0">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <div class="navbar-nav ms-auto py-0">
                    ...
                    <a class="nav-item nav-link" data-bs-target="#createAccountModal" data-bs-toggle="modal">Signup</a>
                </div>
                <a data-bs-target="#loginModal" data-bs-toggle="modal" class="btn btn-primary py-2 px-4 ms-3">Login</a>
            </div>
        </nav>
                    ...
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                            ...
                            <a data-bs-target="#loginModal" data-bs-toggle="modal"
                                class="btn btn-outline-light py-md-3 px-md-5 animated slideInRight">Login</a>
                        </div>
                    </div>
                </div>
            ...
            <div class="row gx-0">
                <div class="col-lg-4 wow zoomIn" data-wow-delay="0.1s">
                    <div class="bg-primary shadow d-flex align-items-center justify-content-center p-4"
                        ...
                        <div class="ps-4">
                            ...
                            <h1 class="text-white mb-0" data-toggle="counter-up">{{ $allUsers }}</h1>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 wow zoomIn" data-wow-delay="0.3s">
                    <div class="bg-light shadow d-flex align-items-center justify-content-center p-4"
                        ...
                        <div class="ps-4">
                            <h5 class="text-primary mb-0">Machines</h5>
                            <h1 class="mb-0" data-toggle="counter-up">{{ $allMachines }}</h1>
                        </div>
                    </div>
                </div>
    ...
    <div class="container-fluid py-5 wow fadeInUp" data-wow-delay="0.1s" id="services">
        <div class="container py-5">
            <div class="section-title text-center position-relative pb-3 mb-5 mx-auto" style="max-width: 600px;">
                ...
                <h1 class="mb-0">Vendo Solutions for Your Peso WIFI Business</h1>
            </div>
            <div class="row g-5">
                ...
                <div class="col-lg-4 col-md-6 wow zoomIn" data-wow-delay="0.9s">
                    <div
                        class="service-item bg-light rounded d-flex flex-column align-items-center justify-content-center text-center">
                        <div class="service-icon">
                            <img src="/reports.svg" alt="" srcset="">
                        </div>
            ...
            <div class="row g-5">
                <div class="col-lg-4 wow slideInUp" data-wow-delay="0.3s">
                    <div class="team-item bg-light rounded overflow-hidden">
                        ...
                        <div class="text-center py-4">
                            <h4 class="text-primary">Dane Isid Cañete</h4>
                ...
                <div class="col-lg-4 wow slideInUp" data-wow-delay="0.6s">
                    <div class="team-item bg-light rounded overflow-hidden">
                        ...
                        <div class="text-center py-4">
                            <h4 class="text-primary">Khyle Ryan Cañazares</h4>
                            <p class="text-uppercase m-0">Developer</p>
                        </div>
                    </div>
                </div>
    ...
    @if (session()->pull('errorLoginUser'))
        <script>
            setTimeout(() => {
                Swal.fire({
                    position: 'center',
    ...
    @endif
    @if (session()->pull('successCreateUser'))
        <script>
            setTimeout(() => {
                Swal.fire({
                    position: 'center',
        ...
        {{ session()->forget('successCreateUser') }}
    @endif
</body>
